...
{
    public class CameraViewRenderer : ViewRenderer<Questy.CameraView, CameraPreview>
    {
        CameraPreview cameraPreview;

        protected override void OnElementChanged(ElementChangedEventArgs<Questy.CameraView> e)
        {
