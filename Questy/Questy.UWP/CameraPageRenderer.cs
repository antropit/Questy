    ...
    public class CameraPageRenderer : PageRenderer
    {
        ...
        async Task InitializeCameraAsync()
        {
            if (mediaCapture == null)
            {
                ...
                var cameraDevice = devices.FirstOrDefault(c => c.EnclosureLocation != null && c.EnclosureLocation.Panel == Windows.Devices.Enumeration.Panel.Front);
